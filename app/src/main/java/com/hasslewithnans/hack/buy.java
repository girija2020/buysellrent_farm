...
//        recyclerView.setLayoutManager(new LinearLayoutManager(this));
//
        g21 = findViewById(R.id.g2);
        g21.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                        String installations = jsonObjectValue.getString("installations");
                        ...
                        String soiltype = jsonObjectValue.getString("soiltype");
//                        String years = jsonObjectValue.getString("years");
//                        String croprot = jsonObjectValue.getString("rotations");
                        placesList.add(new data("District:" + district,"Mandal:" + mandal,"village:" + village,"survey_no:" + survey_no, "khata_no:" + khata_no, "Cost:"+ cost, "area:"+area,"Phone number:" + phone_number, "Crop type:" + soiltype, "watersource:"+watersource ));
...
////                    String imageUrl = placeSnapshot.child("imageUrl").getValue(String.class);
                ...
                PlaceAdapter placeAdapter = new PlaceAdapter(placesList);
