...
////        basicReadWrite();
//    }
    TextInputEditText editCost,editPh_number,editArea,editWaterSource,editSoilType,editDistrict, editMandal,editVillage,editSurvey_no,editKhata_no;
    Button buttonAdd;
    Button g_back;
...
//        editInstall = findViewById(R.id.installments);
        editDistrict = findViewById(R.id.district);
        editMandal = findViewById(R.id.mandal);
        editVillage = findViewById(R.id.village);
        editSurvey_no = findViewById(R.id.survey_no);
        editKhata_no = findViewById(R.id.khata_no);
...
//        email = findViewById(R.id.user_details);
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String district,mandal,village,survey_no,khata_no, negotiation,watersource,soiltype,installations;
...
//                    email = user.getEmail().toString();
                ...
                if (TextUtils.isEmpty(district)) {
                    Toast.makeText(details.this, "Enter district", Toast.LENGTH_SHORT).show();
                    return;
                }
